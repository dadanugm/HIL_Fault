...
for j in range (datashape[0]):
    phs1.plot(time[j],fault1_1[j],'g-',color='green',marker='.',linewidth=2,markersize=2)
    phs1.plot(time[j],fault1_2[j],'b-',color='blue',marker='.',linewidth=2,markersize=2)
    phs1.plot(time[j],fault1_3[j],'r-',color='red',marker='.',linewidth=2,markersize=2)
    phs2.plot(time[j],fault2_1[j],'g-',color='green',marker='.',linewidth=2,markersize=2)
    phs2.plot(time[j],fault2_2[j],'b-',color='blue',marker='.',linewidth=2,markersize=2)
    phs2.plot(time[j],fault2_3[j],'r-',color='red',marker='.',linewidth=2,markersize=2)
    phs3.plot(time[j],fault3_1[j],'g-',color='green',marker='.',linewidth=2,markersize=2)
    phs3.plot(time[j],fault3_2[j],'b-',color='blue',marker='.',linewidth=2,markersize=2)
    phs3.plot(time[j],fault3_3[j],'r-',color='red',marker='.',linewidth=2,markersize=2)
